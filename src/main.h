...
const int64_t nDiffChangeTarget = 5; // Patch effective @ block 67200
const int64_t multiAlgoDiffChangeTarget = 10; // block 145000 where multi-algo work weighting starts 145000
const int64_t alwaysUpdateDiffChangeTarget = 20; // block 400000 after which all difficulties are updated on every block
